...
@app.route("/")
def home():
    if os.path.exists(f"../frontend/public/resaved.jpg"):
        os.remove(f"../frontend/public/resaved.jpg")
    
    if os.path.exists(f"../frontend/public/img.jpg"):
        os.remove(f"../frontend/public/img.jpg")
...
def upload():
    ...
    f1 = "./uploads/img.jpg"
    shutil.copy(f1, "../frontend/public")

    f2 = "resaved.jpg"
    shutil.copy(f2, "../frontend/public")
